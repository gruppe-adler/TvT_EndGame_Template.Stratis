...
[QGVARMAIN(loadoutApplied), [_loadoutTarget, _unitLoadout], _loadoutTarget] call CBA_fnc_targetEvent;

_loadoutTarget setVariable [QGVARMAIN(applicationCount), (_loadoutTarget getVariable [QGVARMAIN(applicationCount), 0]) + 1, true];
