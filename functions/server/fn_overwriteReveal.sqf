...
[{
    [{_fsmID = BIS_moduleHvtObjectivesInstance_endGameObjective getVariable "BIS_moduleHvtObjective_fsm"; !isNil "_fsmID"},{
        private _fsmID = BIS_moduleHvtObjectivesInstance_endGameObjective getVariable "BIS_moduleHvtObjective_fsm";
        //save variables
